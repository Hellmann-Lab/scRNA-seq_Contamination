...
```{r expression_frac}
topGenes <- readRDS("Analysis/files/top10_PT_markers.RDS")
...
## SUPPL. FIGURE S9: cell type UMAP all replicates
...
## SUPPL. FIGURE S10: Slc34a1 UMAPs all replicates
...
## SUPPL. FIGURE S11: Effect on marker gene detection
...
### S11B: Overlap of top10 genes with Panglao markers

```{r panglao_suppl1}
panglao_markers <- readRDS("Analysis/files/panglao_markers_Mm.RDS") 
sigSEU<- readRDS("Analysis/files/DE_seurat_sigUP.RDS")  %>% 
...
```
## SUPPL. FIGURE S12: Absolute evaluation metrics
...
## SUPPL. FIGURE S13: Evaluation of different parameter settings
